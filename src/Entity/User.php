...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
   ...
   #[ORM\Column(length: 14, nullable: true)]
    ...
    min: 14,
    max: 14,
    exactMessage: 'Le SIRET doit contenir exactement 14 chiffres.'
    )]
    #[Assert\Regex(
    pattern: '/^\d+$/',
    ...
    public function getPhoneFixed(): ?string { return $this->phoneFixed; }
    public function setPhoneFixed(?string $phoneFixed): static { $this->phoneFixed = $phoneFixed; return $this; }

    public function getPhoneMobile(): ?string { return $this->phoneMobile; }
    public function setPhoneMobile(?string $phoneMobile): static { $this->phoneMobile = $phoneMobile; return $this; }
    ...
    public function setCompanyType(?string $companyType): static { $this->companyType = $companyType; return $this; }
    ...
    public function getCommercialCourt(): ?string { return $this->commercialCourt; }
    public function setCommercialCourt(?string $commercialCourt): static { $this->commercialCourt = $commercialCourt; return $this; }
}